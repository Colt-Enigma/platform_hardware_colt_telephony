...
public class ColtExtTelephony extends IExtTelephony.Stub {
    ...
    private static ColtExtTelephony sInstance;
    ...
    public static ColtExtTelephony getInstance(Context context, Phone[] phones,
            CommandsInterface[] commandsInterfaces) {
        if (sInstance == null) {
            sInstance = new ColtExtTelephony(context, phones, commandsInterfaces);
        }

        return sInstance;
    }

    private ColtExtTelephony(Context context, Phone[] phones,
            CommandsInterface[] commandsInterfaces) {
